...
const AppContent: React.FC = () => {
    ...
    return (
        <ErrorBoundary>
            <div className="font-sans min-h-screen flex flex-col bg-white selection:bg-black selection:text-white transition-colors duration-300 overflow-x-hidden w-full">
