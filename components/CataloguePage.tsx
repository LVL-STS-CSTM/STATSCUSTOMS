...
const CataloguePage: React.FC<CataloguePageProps> = ({ products, onProductClick, initialFilter, onNavigate }) => {
    ...
    return (
        <div className="bg-white min-h-screen font-grotesk">
            ...
            <div className="max-w-[1840px] mx-auto px-2 md:px-8">
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 py-8 md:py-24">
                    ...
                    <div className="flex-grow">
                        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 md:mb-12 gap-4 md:gap-6 pb-4 md:pb-6 border-b border-zinc-100">
                        ...
                        <div className="lg:hidden sticky top-0 z-40 bg-white border-b border-zinc-100 mb-4 md:mb-6 -mx-2 md:-mx-8">
                        ...
                        <div className="mb-8">
                            <ProductGrid 
                                ...
                                layout={gridColumns === 1 ? 'grid-lg' : 'grid-sm'}
                            />
                        </div>
