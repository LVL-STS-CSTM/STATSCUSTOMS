            ...
            {!hideTextOverlay && (
                <div className={`relative z-10 w-full max-w-screen-2xl mx-auto ${paddingClass}`}>
                    <div className="max-w-xl text-white">
                        ...
                        <p className={`${descriptionSize} leading-relaxed mb-10 text-white/70 font-grotesk max-w-sm uppercase tracking-[0.3em] animate-fade-in-up [animation-delay:200ms] whitespace-pre-line antialiased`}>
                            {description}
                        </p>
                        ...
                        {buttonText && buttonCollectionLink && (
                            <div className="animate-fade-in-up [animation-delay:300ms]">
                                ...
                                >
                                    ...
                                    <span className="relative z-10 text-white text-[10px] font-bold uppercase tracking-[0.3em] group-hover:tracking-[0.4em] transition-all duration-500 font-grotesk">
                                        {buttonText}
                                    </span>
                                </button>
                            </div>
