...
const internalPages: View[] = [
    'browse', 'catalogue', 'about', 'partners', 'contact', 'faq', 
    'terms-of-service', 'return-policy', 'privacy-policy', 'materials', 'the-team', 'our-process', 'mockup-generator', 'track-project'
];
