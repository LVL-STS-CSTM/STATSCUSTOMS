                ...
                <div className="relative flex flex-col">
                    ...
                    {isSubmitted ? (
                        <div className="p-8 md:p-12 text-center flex-grow flex flex-col justify-center">
                            ...
                            <h2 className="text-2xl font-rheiborn uppercase tracking-wider text-gray-900">You're In!</h2>
                        ...
                        <div className="p-8 md:p-12 flex-grow flex flex-col justify-center">
                            <h2 className="text-3xl font-rheiborn uppercase tracking-wider text-gray-900 text-center">{subscriptionModalContent.title}</h2>
