                ...
                <section className="bg-white py-16 md:py-32 px-0 md:px-4 border-b border-zinc-100 last:border-0 relative z-20 transition-colors duration-300">
                    <div className="max-w-[1600px] mx-auto px-4 md:px-8">
                        <div className="text-center mb-16 md:mb-24">
                            <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-[0.5em] block mb-6 font-grotesk">Featured Collection</span>
                            <h2 className="font-eurostile font-bold text-xl md:text-2xl lg:text-3xl tracking-[0.1em] text-zinc-900 uppercase leading-none">
